        ...
        <div class="dropdown ms-4">
          ...
          <ul class="dropdown-menu" aria-labelledby="languageDropdown">
            <li v-for="language in languages" :key="language.id">
              <span @click="changeLanguage(language.code)" class="dropdown-item">{{language.name}}</span>
            </li>
          </ul>
        </div>
        <div v-if="user" class="dropdown p-0 ms-4">
          ...
          <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
            <li class="accountList">
              <router-link :to="{name:'Account'}" class="px-3 text-decoration-none">My Account</router-link>
            </li>
            <li class="accountList">
              <button @click="logout()" class="px-3">Logout</button>
            </li>
          </ul>
        </div>
    ...
    <base-modal id="userInfoModal">
      <template #modalBody>
        <div class="px-2 py-3 px-lg-5">
          <div class="d-flex">
            <button @click="userInfoModal.hide()" class="text-white backBtn fs-4">
...
export default {
  ...
  methods: {
    ...
    setCode(event, elementId) {
      if (elementId !== "codeSix" && !isNaN(event.target.value)) {
    ...
    changeLanguage(langCode) {
      ...
      this.$store.commit("setLang", langCode);
    }
  }
};
</script>
